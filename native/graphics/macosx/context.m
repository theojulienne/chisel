...
void _chisel_native_graphicscontext_set_fill_color( native_handle native, native_handle ncolor ) {
	NSGraphicsContext *gc = (NSGraphicsContext *)native;
	CGContextRef context = (CGContextRef)[gc graphicsPort];
	CGColorRef color = (CGColorRef)ncolor;
	
	CGContextSetFillColorWithColor( context, color );
}

void _chisel_native_graphicscontext_set_stroke_color( native_handle native, native_handle ncolor ) {
	NSGraphicsContext *gc = (NSGraphicsContext *)native;
	CGContextRef context = (CGContextRef)[gc graphicsPort];
	CGColorRef color = (CGColorRef)ncolor;
...
void _chisel_native_graphicscontext_prepare_flip( native_handle native, int yIncreasesUp, CLFloat width, CLFloat height ) {
	NSGraphicsContext *gc = (NSGraphicsContext *)native;
	CGContextRef context = (CGContextRef)[gc graphicsPort];
	
	// where can we restore from this?
